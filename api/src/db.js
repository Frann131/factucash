...
const { Client, Product, Provider, Purchase, Sale, User } = sequelize.models;


// Aca vendrian las relaciones
// Product.hasMany(Reviews);
User.hasMany(Sale, { as: 'Sale' });
Sale.belongsTo(User, { as: 'User' });

Client.hasMany(Sale, { as: 'Sale' });
...
Provider.hasMany(Purchase, { as: 'Purchase' });
Purchase.belongsTo(Provider, { as: 'Provider' });
